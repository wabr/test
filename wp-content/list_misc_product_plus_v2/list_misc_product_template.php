...
<table class="table_org">
	...
	<tr>
		...
		<?php echo $options['column1']==''?'':'<td nowrap>'.checkLink_plus('catalog',$options['linkat'],$product['catalog'],$product['url']).'</td>';?>
		<?php echo $options['column2']==''?'':'<td>'.checkLink_plus('desc',$options['linkat'],$product['desc'],$product['url']).'</td>'; ?>
		<?php echo $options['column3']==''?'':'<td>'.checkLink_plus('desc2',$options['linkat'],$product['desc2'],$product['url']).'</td>'; ?>
		<?php echo $options['column4']==''?'':'<td>'.checkLink_plus('desc3',$options['linkat'],$product['desc3'],$product['url']).'</td>'; ?>
