						...
						$this_inputs.each( function(){
							...
							if ( 'checkbox' === field_type ) {
								...
								if ( 0 !== $this_wrapper.find( 'input[type="checkbox"]').length ) {
									...
									var $firstCheckbox = $this_wrapper.find('input[type="checkbox"]:first');

									required_mark = typeof $firstCheckbox.data( 'required_mark' ) !== 'undefined' ? $firstCheckbox.data( 'required_mark' ) : 'not_required';
